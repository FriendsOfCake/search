...
class LikeTest extends TestCase
{
    ...
    public function testWildcardsEscapingSqlserver()
    {
        ...
        $filter = new Like('title', $manager, ['escapeDriver' => 'Sqlserver']);
        $filter->args(['title' => 'part_1 ? 100% *']);
        $filter->query($articles->find());
        $filter->process();
    ...
    public function testWildcardsBeforeAfterSqlserver()
    {
        ...
        $filter = new Like('title', $manager, ['before' => true, 'after' => true, 'escapeDriver' => 'Sqlserver']);
    ...
    public function testWildcardsAlternativesSqlserver()
    {
        ...
        $filter = new Like(
            'title',
            $manager,
            ['before' => true, 'after' => true, 'wildcardAny' => '%', 'wildcardOne' => '_', 'escapeDriver' => 'Sqlserver']
        );
        $filter->args(['title' => '22% 44_']);
        $filter->query($articles->find());
        $filter->process();
